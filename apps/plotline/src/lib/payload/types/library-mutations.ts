...
import type { MediaStatus, MediaType, StreamingPlatform, WatchEventType } from '@plotline/shared/constants/media'
...
export type AddToListTmdbMediaInput = Pick<
  ...
  > &
  Required<
  Pick<AddToListInput, 'mediaType' | 'title' | 'tmdbId'>
>
...
export function buildAddToListInputs({
  ...
  const mediaFields = hasAddToListMediaId(media)
