    ...
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) =>
          date.toLocaleString(locale?.code ?? FALLBACK_LOCALE_CODE, { month: 'short' }),
        ...formatters,
      }}
      locale={locale}
...
function CalendarDayButton({
  ...
  React.useEffect(() => {
    // Portaled calendars are often still at (0, 0) when this runs; default
    // focus() would scroll the document to the top of the page.
  ...
  return (
    <Button
      ...
      data-day={toIsoDateString(day.date)}
