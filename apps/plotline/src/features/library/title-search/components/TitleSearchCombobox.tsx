...
import { TitleSearchComboboxItem } from '../components/TitleSearchComboboxItem'
...
export function TitleSearchCombobox({
  ...
  const { emptyMessage, handleInputValueChange, handleValueChange, isFetching, items } =
  ...
  return (
    ...
    >
      ...
      <ComboboxContent>
        ...
        <ComboboxList>
          {(item: TitleSearchItem) => <TitleSearchComboboxItem item={item} key={item.id} />}
        </ComboboxList>
      </ComboboxContent>
    </Combobox>
  )
