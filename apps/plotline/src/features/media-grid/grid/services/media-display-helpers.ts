...
export function formatEpisodeCount(episodeCount?: null | number): null | string {
  if (!episodeCount) {
    return null
  }
...
export function toMediaDisplayFromTmdbResult(result: TmdbSearchResultItem): MediaDisplay | null {
