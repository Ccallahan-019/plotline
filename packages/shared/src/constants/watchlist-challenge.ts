...
export const LIST_STATUSES = ['planned', 'in_progress', 'completed', 'skipped'] as const
...
export const CHALLENGE_STATS_STATUSES = ['not_started', 'active', 'completed', 'overdue'] as const
