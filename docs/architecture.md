...
- **`watchlist-memberships` list-scoped fields** — `listStatus`, `completedForListAt`, `countsTowardGoal`, `goalWeight`, `episodesAtJoin`, and `episodesCountedForList` track what counts _for this list_.
